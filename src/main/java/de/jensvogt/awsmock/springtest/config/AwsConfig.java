...
public class AwsConfig {
    ...
    @Bean
    @Primary
    public KmsClient kmsClient(@Autowired(required = false) AwsCredentialsProvider awsCredentialsProvider) {
        return buildClient(KmsClient.builder(), awsCredentialsProvider);
    }
